...
module.exports = function() {
  ...
  if (this.params.database.type === 'BDB') {
    ...
    open_params = {
      type: this.params.database.type,
      db_library: this.params.database.db_library,
      db_file: this.params.database.db_file,
      env_dir: this.params.database.env_dir,
      key_type: this.params.database.key_type
    };
